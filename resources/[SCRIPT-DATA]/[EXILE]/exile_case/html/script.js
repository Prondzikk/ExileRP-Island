                    ...
                    e.play(), setTimeout(function() {
                        setTimeout(function() {
                            $("#CaseOpenCard46").addClass("winning-item"), $("body").on("keyup", function(e) {
                                27 == e.which && (window.location.reload(), $.post("http://exile_case/mkbuss:NUIoff", JSON.stringify({})))
                            }), Swal.fire({
                                text: "🥳 You got! - " + i,
                                type: "success",
                                ...
                                window.location.reload(), $.post("http://exile_case/mkbuss:NUIoff", JSON.stringify({}))
                            }, function() {
                                return !1
                            })
