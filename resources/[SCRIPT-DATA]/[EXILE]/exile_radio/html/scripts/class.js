...
$( "#playSong" ).click(function()
{
    ...
    updateName($("#url").val());
    $.post('https://exile_radio/play', JSON.stringify(
    {
        url: $("#url").val(),
    }));
});
...
$( "#buttonOff" ).click(function()
{
	...
	$("#nameSong").text(locales.nameSong);
	$("#timeSong").text(locales.timeSong.format("00:00:00"))
    $.post('https://exile_radio/stop', JSON.stringify({}));
});

$( "#volumeup" ).click(function()
{
    $.post('https://exile_radio/volumeup', JSON.stringify({}));
});

$( "#volumedown" ).click(function()
{
    $.post('https://exile_radio/volumedown', JSON.stringify({}));
});