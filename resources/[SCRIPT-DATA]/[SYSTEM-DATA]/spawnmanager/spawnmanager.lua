...
local function freezePlayer(id, freeze)
    ...
    if not freeze then
        ...
        Citizen.InvokeNative(0x239528EACDC3E7DE,  player, false)
    else
        if IsEntityVisible(ped) then
            Citizen.InvokeNative(0xEA1C610A04DB6BBB, ped, false)
        end

        SetEntityCollision(ped, false)
        FreezeEntityPosition(ped, true)
        --SetCharNeverTargetted(ped, true)
        Citizen.InvokeNative(0x239528EACDC3E7DE,  player, true)
...
function spawnPlayer(spawnIdx, cb)
    ...
    CreateThread(function()
        ...
        Citizen.InvokeNative(0xAAA34F8A7CB32098, ped)
        --Citizen.InvokeNative(0x6B76DC1F3AE6E6A3, ped, 300) -- TODO: allow configuration of this?
        Citizen.InvokeNative(0x4899CB088EDF59B8, ped) -- TODO: make configurable (V behavior?)
