...
function notifyAlertSMS (number, alert, listSrc)
  if PhoneNumbers[number] ~= nil and alert.numero ~= nil then
	local mess = 'Od #' .. alert.numero  .. ': ' .. alert.message
	if alert.coords ~= nil then
		mess = mess.. ' GPS: ' .. math.round(alert.coords.x) .. ', ' .. math.round(alert.coords.y)
	end
