Locales['pl'] = {
  ...
  ['have_deposited'] = 'Schowałeś ~y~x%s~s~ ~b~%s~s~',
  ['free_prop'] = 'mieszkanie do kupna',
  ['property'] = 'mieszkanie',
  ['enter'] = 'Wejdź',
  ['leave'] = 'Sprzedaj (do urzędu)',
  ['sell'] = 'Sprzedaj (dla obywatela)',
  ['buy'] = 'Kup',
  ['rent'] = 'Wynajmij',
  ['visit'] = 'Odwiedź',
  ['press_to_menu'] = 'Naciśnij ~INPUT_CONTEXT~ aby otworzyć menu',
  ...
  ['inventory'] = 'ekwipunek',
  ['amount'] = 'Ilość',
  ['amount_invalid'] = 'Nieprawidłowa wartość',
  ['press_to_exit'] = 'Naciśnij ~INPUT_CONTEXT~ aby wyjść z mieszkania',
