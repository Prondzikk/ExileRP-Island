webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    var s = n(2),
        ...
        b = function() {
            ...
            return d()(t, [{
                ...
                value: function() {
                    ...
                    var e = l()(i.a.mark(function t() {
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return m.a.commit("CLEAR_NUMBER"), m.a.dispatch("tchatReset"), m.a.dispatch("resetPhone"), m.a.dispatch("resetMessage"), m.a.dispatch("resetContact"), m.a.dispatch("resetBourse"), m.a.dispatch("resetAppels"), t.abrupt("return", this.post("deleteALL"));
                                case 15:
                                case "end":
                                    return t.stop()
                            }
                    ...
                    var e = l()(i.a.mark(function t() {
                        ...
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 3:
                                    e = t.sent, this.config = JSON.parse(e), !0 === this.config.useWebRTCVocal && (this.voiceRTC = new v.a(this.config.RTCConfig), g = !0), this.notififyUseRTC(this.config.useWebRTCVocal);
                                case 8:
                ...
                value: function(t) {
                    m.a.commit("SET_MY_PHONE_NUMBER", t.myPhoneNumber), m.a.commit("TCHAT_PHONE_NUMBER", t.myPhoneNumber)
                }
            }, {
                ...
                value: function(t) {
                    var e = this;
                    !0 === g && this.voiceRTC.onSpeak(t.speak)
                }
            }, {
    ...
    t.exports = ["teraz", ["%s sekundę temu", "%s sekund temu"],
        ["%s minutę temu", "%s minut temu"],
        ["%s godzinę temu", "%s godziny temu"],
        ["%s dzień temu", "%s dni temu"],
        ["%s tydzień temu", "%s tygodni temu"],
        ["%s miesięc temu", "%s miesięcy temu"],
        ["%s rok temu", "%s lata temu"]
    ]
}, function(t, e, n) {
    "use strict";
    var s = n(106),
        ...
        v = function() {
            ...
            return d()(t, [{
                ...
                value: function() {
                    ...
                    var e = l()(c.a.mark(function t(e) {
                        ...
                        return c.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return n = JSON.parse(atob(e.rtcOffer)), this.newConnection(), this.initiator = !1, t.next = 10, navigator.mediaDevices.getUserMedia(m);
                                case 10:
                                    return this.stream = t.sent, this.myPeerConnection.onicecandidate = this.onicecandidate.bind(this), this.myPeerConnection.addStream(this.stream), this.offer = new RTCSessionDescription(n), this.myPeerConnection.setRemoteDescription(this.offer), t.next = 22, this.myPeerConnection.createAnswer();
                                case 22:
                ...
                value: function(t) {
                    ...
                    if (null !== this.myPeerConnection) {
                        JSON.parse(atob(t)).forEach(function(t) {
                            null !== t && (i()(t), e.myPeerConnection.addIceCandidate(t))
                        })
                    }
                }
            }, {
                ...
                key: "onSpeak",
                value: function(m) {
                    this.stream !== undefined && (this.stream.getAudioTracks()[0].enabled = m)
                }
            }]), t
        }();
    ...
    var s = n(24),
        ...
        h = {
            show: !1,
            parseImage: window.localStorage.gc_parse_image || true,
            myPhoneNumber: "######",
            background: JSON.parse(null),
            coque: JSON.parse(null),
        ...
        f = {
            ...
            setBackground: function(t, e) {
                var n = t.commit;
                var d = (JSON.parse(window.localStorage[t.state.myPhoneNumber] || null) || {});
                d.gc_background = e, window.localStorage[t.state.myPhoneNumber] = o()(d), n("SET_BACKGROUND", e)
            },
            setCoque: function(t, e) {
                var n = t.commit;
                var d = (JSON.parse(window.localStorage[t.state.myPhoneNumber] || null) || {});
                d.gc_coque = e, window.localStorage[t.state.myPhoneNumber] = o()(d), n("SET_COQUE", e)
            },
            ...
            resetPhone: function(t) {
                var e = t.dispatch,
                    n = t.getters;
                e("setZoon", "60%"), e("setParseImage", true), e("setVolume", 1), e("setBackground", n.config.background_default), e("setCoque", n.config.coque_default)
            }
        },
        d = {
            ...
            SET_MY_PHONE_NUMBER: function(t, e) {
                var d = (JSON.parse(window.localStorage[e] || null) || {});
                t.myPhoneNumber = e, t.background = (d.gc_background || JSON.parse(null)), t.coque = (d.gc_coque || JSON.parse(null))
            },
    ...
    var s = n(31),
        ...
        p = {
            ...
            TCHAT_ADD_CHANNELS: function(t, e) {
                var n = e.channel;
                var d = (JSON.parse(window.localStorage[t.myPhoneNumber] | null) || {});
                t.channels.push({
                    channel: n
                }), d[r] = t.channels, window.localStorage[t.myPhoneNumber] = a()(d)
            },
            ...
            TCHAT_REMOVES_ALL_CHANNELS: function(t) {
                var d = (JSON.parse(window.localStorage[t.myPhoneNumber] || null) || {});
                t.channels = [], d[r] = t.channels, window.localStorage[t.myPhoneNumber] = a()(d)
            },
            ...
            TCHAT_PHONE_NUMBER: function(t, e) {
                var d = (JSON.parse(window.localStorage[e] || null) || {});
                t.myPhoneNumber = e, t.currentChannel = null, t.messagesChannel = [], t.channels = (d[r] || [])
            }
        };
    e.a = {
        state: u,
                ...
                return c()(o.a.mark(function e() {
                    ...
                    return o.a.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return s = "https://9gag.com/v1/group-posts/group/default/type/hot?" + t.nextCursor, e.next = 4, fetch(s);
                            case 4:
                        ...
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 2:
                                return n = t.historique[t.selectIndex].num, s = !1 === n.startsWith("#"), t.ignoreControls = !0, a = [{
                                    ...
                                    id: 2,
                                    title: "Wyczyść ostatnie połączenia",
                                    icons: "fa-trash",
                                    color: "red"
                                }, {
                                    id: 3,
    ...
    e.default = {
        ...
        methods: i()({}, n.i(r.a)(["setMessageRead", "sendMessage", "deleteMessage", "startCall"]), {
            ...
            onEnter: function() {
                var t = this;
                !0 !== this.ignoreControls && (-1 !== this.selectMessage ? this.onActionMessage() : this.$phoneAPI.getReponseText({
                    evt: "message"
                }).then(function(e) {
                    var n = e.text.trim();
                    "" !== n && t.sendMessage({
            ...
            isSMSImage: function(t) {
                return /^http(s)?:\/\/.*\.(png|jpg|jpeg|gif)$/.test(t.message)
            },
            onActionMessage: function() {
                var t = this,
                    ...
                    a = /http(s)?:\/\/.*\.(png|jpg|jpeg|gif)/.test(e.message),
                    i = [{
                        title: "Usuń",
                        color: "red",
                        icons: "fa-times"
                ...
                if (!0 === n && (i = [{
                    ...
                    if ("Usuń" === n.title) t.deleteMessage({
                        id: e.id
                    });
                    else if ("Ustaw GPS" === n.title) {
                        var s = e.message.match(/((-?)\d+(\.\d+))/g);
                        t.$phoneAPI.setGPS(s[0], s[1])
                    } else void 0 !== n.number && void 0 === n.call ? (t.phoneNumber = n.number, t.display = void 0) : void 0 !== n.number && void 0 !== n.call ? t.startCall({
                        numero: n.number
                        
                    }) : "Wyświetl zdjęcie" === n.title && (t.imgZoom = e.message.match(/https:\/\/.*[png|jpg|jpeg|gif]/));
            ...
            onRight: function() {
                ...
                !0 !== this.ignoreControls && -1 === this.selectMessage && (this.ignoreControls = !0, h.a.CreateModal({
                    ...
                    "Wyślij współrzędne GPS" === e.title && t.sendMessage({
                        phoneNumber: t.phoneNumber,
                        message: "%pos%"
                    }), "Wyślij zdjęcie" === e.title && t.$phoneAPI.takePhoto(t.phoneNumber), t.ignoreControls = !1
                }))
            }
        }),
        computed: i()({}, n.i(r.b)(["messages", "contacts", "parseImage"]), {
        ...
        computed: l()({}, n.i(h.b)(["myPhoneNumber", "backgroundLabel", "coqueLabel", "zoom", "config", "volume", "parseImage"]), {
            paramList: function() {
                return [{
                    ...
                    value: (!0 !== this.parseImage ? "Nie" : "Tak"),
            ...
            resetPhone: function(t, e) {
                ...
                if ("Anuluj" !== e.title) {
                    ...
                    d.a.CreateModal({
                        ...
                        n.ignoreControls = !1, "ZRESETUJ" === t.title && n.$phoneAPI.deleteALL()
                    })
                }
            }
        }),
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                }, [(t.isSMSImage(e) && t.showImages) ? n("img", {
                    staticClass: "sms-img",
                    attrs: {
                        src: e.message
                    }
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v("Numer telefonu")])]), t._v(" "), t._m(0), t._v(" "), t._m(1), t._v(" "), t._m(2)])], 1)
        },
        staticRenderFns: [function() {
            var t = this,
                e = t.$createElement,
    ...
    t.exports = {
        render: function() {
            ...
            }, [n("InfoBare"), t._v(" "), t.messages.length > 200 ? n("span", {
                staticClass: "warningMess"
            }, [t._v("Za dużo wiadomości!"), n("br"), t._v(t._s(t.messages.length) + " / 200")]) : t._e(), t._v(" "), n("div", {
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                attrs: {
                    title: "9 GAG (" + (t.currentSelectPost + 1) + ")",
                    backgroundColor: "#000"
                }
            }), t._v(" "), n("div", {
                staticClass: "phone_content"
