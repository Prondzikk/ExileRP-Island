...
AddEventHandler('gcphone:bankTransfer', function(data)
      ESX.ShowNotification("~r~Funkcja chwilowo niedostepna")
      TriggerServerEvent('exile_logs:triggerLog', "Gracz próbował przelać pieniądze dla " .. data.id .. " w wysokości $" .. data.amount, 'anticheat')
end)