...
function newPhoneProp()
	deletePhone()
	telefon = Citizen.InvokeNative(0x509D5878EB39E842, `prop_amb_phone`, 1.0, 1.0, 1.0, 1, 1, 0)
	AttachEntityToEntity(telefon, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 28422), 0.0, 0.0, 0.0, 0.2, 0.0, 0.0, 1, 1, 0, 0, 2, 1)
end
...
function PhonePlayAnim (status, freeze)
	...
	local trunk = exports['exile_trunk']:checkInTrunk()
