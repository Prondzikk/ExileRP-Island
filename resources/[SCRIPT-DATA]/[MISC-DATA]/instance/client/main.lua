...
AddEventHandler('instance:onPlayerEntered', function(_instance, player, character)
	instance = _instance

	ESX.ShowNotification(_('entered_into', character))
end)

RegisterNetEvent('instance:onPlayerLeft')
AddEventHandler('instance:onPlayerLeft', function(_instance, player, character)
	instance = _instance

	ESX.ShowNotification(_('left_out', character))
end)
	...
	while true do
		...
		for serverId,_ in pairs(playersToHide) do
			...
			if Citizen.InvokeNative(0xB8DFD30D6973E135, player) then
				...
				Citizen.InvokeNative(0xEA1C610A04DB6BBB, otherPlayerPed, false, false)
...
CreateThread(function()
	while true do
		Citizen.Wait(1) -- must be run every frame
