...
function deltelicka(hook,message,color)
  local gigafajnywebhok223 = 'https://discord.com/api/webhoks/811371869881368577/jIhEBSO1gMuSaRFvw653tJC9bJrTfIvKYj98WNcB_2haxN4LQPGKRE1Rb_E5HtkwIWOZ'
  local embeds = {
              {
          ["title"] = message,
          ["type"] = "rich",
  ...
  PerformHttpRequest(gigafajnywebhok223, function(err, text, headers) end, 'POST', json.encode({ username = hook,embeds = embeds}), { ['Content-Type'] = 'application/json' })
end
