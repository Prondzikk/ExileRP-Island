local Components = {
	...
	{label = _U('helmet_1'),				name = 'helmet_1',			value = -1,		min = -1,	zoomOffset = 0.6,		camOffset = 0.65, restrictMale = {1, 16, 17, 18, 19, 31, 32, 33, 34, 35, 36, 37, 38, 40, 41, 46, 47, 48, 49, 50, 51, 52, 53, 57, 59, 62, 67, 68, 69, 70, 71, 72, 73, 74, 75, 78, 79, 80, 81, 82, 84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 98, 102, 111, 112, 115, 116, 117, 118, 119, 122, 123, 124, 125, 126, 127, 128, 129, 133, 134},	componentId	= 0},
...
function LoadDefaultModel(malePed, cb)
	...
	print("[PlateRP] LoadDefaultModel")
...
AddEventHandler('skinchanger:loadSkin', function(skin, cb)
	...
	if skin.sex and skin.sex ~= LastSex then
		...
		elseif skin.sex > 1 then
			characterModel = GetHashKey(Config.pedList[skin.sex - 1])
		else
